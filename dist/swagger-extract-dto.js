...
async function processFile(apiFile, targetDir, generateJson, generateJoi) {
  try {
...
const generate = (apiFile, targetDir, generateJson, generateJoi) => {
...
generate(path.resolve(argv.file), path.resolve(argv.out), argv.json, argv.joi);
